            ...
            <div class="modal-body d-flex align-items-center">
                <div class="input-group w-75 mx-auto d-flex">
                    ...
                    <span id="search-icon-1" class="input-group-text p-3"><i class="fa fa-search"></i></span>
                     <a href="logout.php" class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill" id="loginandout">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    if ($insertok){
            ...
            <div class="p-5 bg-light rounded contact-form">
                <div class="row g-4">
                    <div class="col-12 mx-auto text-center">
                        <h1 class="display-5 mb-0">Listing Added!</h1>
                    </div>
        ...
        <div class="container">
            <div class="p-5 bg-light rounded contact-form">
                <div class="row g-4">
                    <div class="col-12 mx-auto text-center">
                        <h1 class="display-5 mb-0">An error occured, please try again.</h1>
                    </div>
