        ...
        if ($status) {
                    ...
                    <div class="p-5 bg-light rounded contact-form">
                        <div class="row g-4">
                            <div class="col-12 mx-auto text-center">
                                <h1 class="display-5 mb-0">Post deletion was successful!</h1>
                            </div>
                            
                            <div class="text-center">
                                        <a href="blog.html"><button type="submit" class="w-50 btn btn-primary border-primary bg-primary rounded-pill">Return to posts page</button><a href="blog.html">
            ...
            <div class="container">
                <div class="p-5 bg-light rounded contact-form">
                    <div class="row g-4">
                        <div class="col-12 mx-auto text-center">
                            <h1 class="display-5 mb-0">Post deletion was unsuccessful!</h1>
                        </div>
